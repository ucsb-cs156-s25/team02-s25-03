...
describe("ArticlesIndexPage tests", () => {
  ...
  test("renders three articles correctly for regular user", async () => {
    ...
    const title = screen.getByText("Some Article Title");
    expect(title).toBeInTheDocument();

    const url = screen.getByText("https://gmail.com");
    expect(url).toBeInTheDocument();

    const explanation = screen.getByText("The article is actually Gmail");
    expect(explanation).toBeInTheDocument();

    const email = screen.getByText("karena_lai@ucsb.edu");
